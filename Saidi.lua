...
msg.Name_Controller = '  ⌁ ＳＯＵＲＣＥ  ⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥ '
...
{
{text = '  ⌁ ＳＯＵＲＣＥ𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑', url = 't.me/bbbc6'},
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙ عذرا لا تستطيع استخدام الامر على   ⌁ ＳＯＵＲＣＥ  ⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥  *","md",true)
end
...
local Name = '* •━═━═━═『𝙵𝚘𝚏𝚊』═━═━═━•\n*᥀︙ [⋆⃟➼𝐀𝐇𝐌𝐄𝐃 𝐊𝐇𝐀𝑳𝐄𝐃 ꕸ](t.me/bbbc6)*\n*᥀︙ [⌁ ＣＨＡＮＮＥＬ ’♥ｌ➝ ˛⁽♥₎ 𓆪](t.me/glalkmeso)*\n• ⃝➼ＦＯＦＡ ＳＯＵＲＣＥ ꗛ'
keyboard = {}
keyboard.inline_keyboard = {
{
{text = '  ⌁ ＳＯＵＲＣＥ𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑', url = "http://t.me/bbbc6"},
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'مطور السورس' or text == 'احمد خالد' or text == '  ⌁ ＳＯＵＲＣＥ  ⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥ ' then
photo = "https://t.me/bbbc6"
local Name = '  ⌁ ＳＯＵＲＣＥ  ⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥   ✅'
keyboard = {}
keyboard.inline_keyboard = {
{
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بلالتتت' or text == 'احمد ااااالمصري' or text == '  ⌁ ＳＯＵＲＣＥ  ⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥ ' then
photo = "https://t.me/BEL666AL"
local Name = 'مبرمج السورس للتواصل معاه بالاسفل ✅*'
keyboard = {}
keyboard.inline_keyboard = {
{
