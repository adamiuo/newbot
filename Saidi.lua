...
local Name = '* •━═━═━═『• ⃝➼ＦＯＦＡＳＯＵＲＣＥꗛ』═━═━═━•\n*᥀︙ [⋆⃟➼𝐀𝐇𝐌𝐄𝐃 𝐊𝐇𝐀𝑳𝐄𝐃 ꕸ](t.me/bbbc6)*\n*᥀︙ [𓆩 𝐅𝐎𝐅𝐀 𝐁𝐎𝐓ｌ➝ ˛⁽♥₎ 𓆪](t.me/Fofahj_bot)*\n•━═━═━═『• ⃝➼ＦＯＦＡＳＯＵＲＣＥꗛ』═━═━═━•*'
keyboard = {}
keyboard.inline_keyboard = {
{
{text = 'مطور السورس 🔰', url = "http://t.me/bbbc6"},
},
}
local msgg = msg_id/2097152/0.5
...
if Redis:get(Fofa.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
data = {
{
{text = '• ⃝➼ＦＯＦＡ ＳＯＵＲＣＥ', url = 'glalkmeso',},
},
}
}
local TextHelp = [[*
