...
ControllerAll = false
local ListSudos ={Sudo_Id,1614314857,5077394172,5069521312}  
...
Status = 'مبرمج السورس'
elseif UserId == 5069521312 then  
Status = 'المبرمج شارون'
elseif UserId == 5077394172 then  
Status = 'المبرمج بلال'
...
elseif tonumber(msg.sender.user_id) == 5069521312 then
msg.Name_Controller = 'المبرمج شارون'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5077394172 then
...
local N = (Redis:get(Saidi.."Name:Bot") or "جانج")
...
{
{text = 'قناه السورس 🔰', url = 't.me/gang_1_bot'}, 
},
}
...
{
{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url='https://t.me/gang_1_bot'},
},
}
}
...
if text == 'رفع نسخه جانج' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ هاذا الامر يخص{ '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ تم استرجاع المجموعات من نسخه جانج')
else
...
NamesBot = (Redis:get(Saidi.."Name:Bot") or "جانج")
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = "http://t.me/gang_1_bot"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if UserId == "5069521312" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙ عذرا لا تستطيع استخدام الامر على المبرمج شارون *","md",true)  
end
if UserId == "5077394172" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙ عذرا لا تستطيع استخدام الامر على المبرمج بلال *","md",true)  
end
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @gang_1_bot"..Creator.."\n"
else
...
data = {
{
{text = '𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄', url = 't.me/gang_1_bot'}, 
},
}
}
...
local Name = '* •━═━═━═『ɢᴀɴɢ』═━═━═━•\n*᥀︙ [𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄 𝟏](t.me/SHA_SEIF_RON)*\n*᥀︙ [𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄 𝟐](t.me/BEL666AL)*\n*᥀︙ [𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐒𝐎𝐔𝐑𝐂𝐄 ](t.me/gang_1_bot)*\n•━═━═━═『ɢᴀɴɢ』═━═━═━•*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس 🔰', url = "http://t.me/gang_1_bot"},
},
{
...
elseif text == 'شارون' or text == 'داد شارون' or text == 'مطور السورس' then
photo = "https://t.me/SHA_SEIF_RON"
local Name = 'المبرمج شارون للتواصل معاه بالاسفل ✅'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '๖ۣۜS ๖ۣۜE ๖ۣۜI ๖ۣۜF 🥀💭 ،', url = "https://t.me/SHA_SEIF_RON"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'بلال' or text == 'احمد اااالمصري' or text == 'مبرمج السورس' then
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ اليك قسم الالعاب من سورس جانج ',"md",false, false, false, false, reply_markup)
end
---زخرفة ----
...
local NamesBot = (Redis:get(Saidi.."Name:Bot") or "جانج")
local BotName = {
'اسمي '..NamesBot..' يروحي',
'اؤمر انا '..NamesBot..'️',
'اسمي '..NamesBot..' يقلبي',
...
if text == (Redis:get(Saidi.."Name:Bot") or "جانج") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local Jabwa = LuaTele.getUser(Saidi)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "جانج")
local BotName = {
'نعم يروحي',
...
if text == (Redis:get(Saidi.."Name:Bot") or 'جانج').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)  
end
...
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "جانج")
local Jabwa = LuaTele.getUser(Saidi)
local bain = LuaTele.getUser(msg.sender.user_id)
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Saidi..'Channel:Join')}, },}}
...
if text == "صور" or text == "اممممير" then
if Redis:get(Saidi.."Status:Games"..msg.chat_id) then
KlamSpeed = {"بغبغاء","عسل","غوريلا","توت","نحله","ماسنجر","مروحه","سبونج بوب","قوقع","كنبه","توم","مساحه","نسكافيه","برايه","ديتول","محمد صلاح","ويجز","ثور","دراجه","قلب","طوب","نانسي عجرم","صحن","فراشه","شجره","نعناع","بنكرياس","اناناس"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Saidi.."mshaher"..msg.chat_id,name)
name = string.gsub(name,"بغبغاء","https://t.me/Exp_java/36")
...
name = string.gsub(name,"مروحه","https://t.me/Exp_java/40")
name = string.gsub(name,"توت","https://t.me/Exp_java/41")
name = string.gsub(name,"ميزان","https://t.me/Exp_java/42")
name = string.gsub(name,"نحله","https://t.me/Exp_java/43")
...
name = string.gsub(name,"مساحه","https://t.me/Exp_java/52")
name = string.gsub(name,"نسكافيه","https://t.me/Exp_java/46")
name = string.gsub(name,"سبونج بوب","https://t.me/Exp_java/47")
name = string.gsub(name,"محمد صلاح","https://t.me/Exp_java/69")
name = string.gsub(name,"ديتول","https://t.me/Exp_java/48")
name = string.gsub(name,"ويجز","https://t.me/HC6HH/16")
name = string.gsub(name,"ثور","https://t.me/Exp_java/67")
name = string.gsub(name,"برايه","https://t.me/Exp_java/49")
name = string.gsub(name,"قلب","https://t.me/Exp_java/60")
name = string.gsub(name,"طوب","https://t.me/Exp_java/57")
name = string.gsub(name,"نانسي عجرم","https://t.me/HC6HH/22")
name = string.gsub(name,"صحن","https://t.me/Exp_java/50")
name = string.gsub(name,"فراشه","https://t.me/Exp_java/51")
name = string.gsub(name,"شجره","https://t.me/Exp_java/54")
...
local CmdStart = '\n*᥀︙ مرحبا بك انا بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "جانج")..
...
local TextHelp = [[*
᥀︙ أهلا بك في قائمة العاب سورس جانج اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس جانج 
