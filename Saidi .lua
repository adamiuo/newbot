...
ControllerAll = false
local ListSudos ={Sudo_Id,1614314857,584023518}
...
elseif tonumber(msg.sender.user_id) == 584023518 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
...
local N = (Redis:get(Saidi.."Name:Bot") or "رزان")
...
{
{text = '⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥', url = 't.me/CCIIUU'},
},
}
...
{
{text = '𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄', url='https://t.me/CCIIUU'},
},
}
}
...
if text == 'رفع نسخه شغف' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ هاذا الامر يخص{ '..Controller_Num(1)..' }* ',"md",true)
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ تم استرجاع المجموعات من نسخه شغف')
else
...
NamesBot = (Redis:get(Saidi.."Name:Bot") or "رزان")
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄', url = "http://t.me/CCIIUU"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @CCIIUU"..Creator.."\n"
else
...
data = {
{
{text = '𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄', url = 't.me/CCIIUU'},
},
}
}
...
local RinkBot = msg.Name_Controller
photo = "https://t.me/CCIIIUU/16148"
local Name = '* •═ꞏＳＡＧＡＦ ＳＯＵＲＣＥ ｢♥｣═•\n*᥀︙ [ＳＡＧＡＦ ꕸ](t.me/CCIIUU)*\n*᥀︙ [ꞏＣＨＡＮＮＥＬ ｢♥｣](t.me/CCIIIUU)*\n•═ꞏＳＡＧＡＦ ＳＯＵＲＣＥ ｢♥｣═•*'
keyboard = {}
keyboard.inline_keyboard = {
{
{text = '⸢𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑⸥', url = "http://t.me/CCIIUU"},
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'مطور السورس' or text == 'شغف' or text == 'مبرمج السورس' then
photo = "https://t.me/CCIIUU"
local Name = '𓆩𝘾𝙊𝙉𝙉𝙀𝘾𝙏 𝙁𝙍𝙊𝙈 𝘽𝙊𝙏𝙏𝙊𝙉𓆪'
keyboard = {}
keyboard.inline_keyboard = {
{
{text = 'ＳＡＧＡＦ ꕸ', url = "https://t.me/CCIIUU"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ اليك قسم الالعاب من سورس شغف ',"md",false, false, false, false, reply_markup)
end
---زخرفة ----
...
local NamesBot = (Redis:get(Saidi.."Name:Bot") or "رزان")
local BotName = {
'اسمي '..NamesBot..' يروحي',
'اؤمر انا '..NamesBot..'️',
'اسمي '..NamesBot..' يقلبي',
...
if text == (Redis:get(Saidi.."Name:Bot") or "رزان") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local Jabwa = LuaTele.getUser(Saidi)
local sudo_info = LuaTele.getUser(Sudo_Id)
local sudo_name = sudo_info.first_name
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "رزان")
local BotName = {
'نعم يروحي',
...
if text == (Redis:get(Saidi.."Name:Bot") or 'رزان').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)
end
...
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "رزان")
local Jabwa = LuaTele.getUser(Saidi)
local bain = LuaTele.getUser(msg.sender.user_id)
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Saidi..'Channel:Join')}, },}}
...
local CmdStart = '\n*᥀︙ مرحبا بك انا بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "رزان")..
...
local TextHelp = [[*
᥀︙ أهلا بك في قائمة العاب سورس شغف اختر نوع الالعاب
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس شغف
